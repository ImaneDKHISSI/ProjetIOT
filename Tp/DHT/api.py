        ...
        if serial.is_valid():
            ...
            if serial.is_valid():
                ...
                if derniere_temperature > 25:
                    ...
                    recipient_list = ['imane.dkhissi@ump.ac.ma']
                    (subject, message, email_from, recipient_list)

                    # Alert WhatsApp
                    account_sid = 'AC8f8215a626547f9b1e26e5a3f4db6d29'
                    auth_token = '9f14be2658ed76062a048e4690405142'
                    ...
                    to='whatsapp:+212682406187'
                    )

                    # Alert Telegram
                    telegram_token = '7828390578:AAEi_0rXx09L49LieO20fjkqzgn2Iirr3v8'
                    chat_id = '6907346270'  # Remplacez par votre ID de chat
